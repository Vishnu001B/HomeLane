...
const ServiceCard = ({ title, image }) => {
  ...
  return (
    <div
      className="relative w-full h-32 md:h-48 lg:h-56 xl:h-72 bg-cover bg-center m-2"
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
        ...
        <button className="mt-4 px-4 py-2 font-serif bg-red-500 text-white rounded" onClick={()=>navagite(`/verticalGarden/:${title}`)}>
          Read more
        </button>
      </div>
    </div>
...
const Blinds = () => {
  return (
    <div className=" px-[5%] py-4 bg-[#EEEEEE]">
      <h1 className="lg:text-4xl font-bold text-2xl  tracking-wide font-serif">Blinds</h1>
