    ...
    >
      ...
      >
        <div className="flex flex-col sm:flex-row">
          ...
          <div className="w-full sm:w-1/2 p-6 bg-gradient-to-r from-blue-100 via-white to-blue-100">
            <h3 className="text-2xl font-semibold text-gray-800 mb-4">{product.name}</h3>
            <div className="flex justify-between items-center mb-6">
              <p className="text-red-600 text-xl font-bold">₹ {product.discountedPrice}</p>
              <p className="text-gray-400 line-through">₹ {product.price}</p>
              <p className="text-green-600">({product.discountPercentage}%) OFF</p>
            </div>
            <p className="text-gray-500 mb-6">{product.delivery}</p>
            <p className="text-gray-700 mb-8 leading-relaxed">
              This product is perfect for those looking to enhance their space with something
              stylish and functional. Made with high-quality materials, it offers both durability
              and a modern look. Whether for your home or office, this product is designed to
