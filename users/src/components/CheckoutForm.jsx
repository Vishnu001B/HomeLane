      ...
      <div className="w-full lg:w-1/3">
        <div className="bg-gray-100 p-4 rounded-md mb-4">
          ...
          <div className="flex items-center mt-2">
            <img src="https://www.whiteteak.com/media/catalog/product/h/l/hl198-10001_4_.jpg?width=156&height=156&canvas=156,156&optimize=high&fit=bounds" alt="Product" className="w-20 h-20 rounded-md" />
            <div className="ml-4">
              <p className="text-sm">Letters Of Love Grand (Large, Chrome) Crystal Chandelier</p>
              <p className="text-sm font-semibold">Rs. 95,450.00</p>
        ...
        <div className="bg-gray-100 p-4 rounded-md">
          ...
          <div className="flex justify-between mt-2">
            ...
            <p className="text-sm">Rs. 95,450.00</p>
          </div>
          <div className="flex justify-between mt-2">
