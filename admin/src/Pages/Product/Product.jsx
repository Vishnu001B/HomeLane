        ...
        <div className="p-4">
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="md:w-1/2 md:pl-4">
                    ...
                    <p className="mb-4"><strong>Discount:</strong> {product.discount}%</p>
                    <p className="mb-4"><strong>Total Price:</strong> ${product.totalPrice}</p>
                    <p className="mb-4"><strong>SKU Code:</strong> {product.skuCode}</p>
                    <p className="mb-4"><strong>Rating:</strong> {product.rating}</p>
                    <p className="mb-4"><strong>Material:</strong> {product.material}</p>
                    <p className="mb-4"><strong>Color:</strong> {product.color}</p>
                    <p className="mb-4"><strong>Categories:</strong> {product.categories}</p>
                    <p className="mb-4"><strong>Specials Category:</strong> {product.specialsCategory.join(', ')}</p>
